...
-- Started on 2022-11-18 01:06:14
...
--
-- TOC entry 9 (class 2615 OID 40982)
...
--
-- TOC entry 238 (class 1259 OID 40983)
-- Name: city; Type: TABLE; Schema: world; Owner: postgres
--
...
ALTER TABLE world.city OWNER TO postgres;

--
-- TOC entry 239 (class 1259 OID 40989)
-- Name: country; Type: TABLE; Schema: world; Owner: postgres
--
...
ALTER TABLE world.country OWNER TO postgres;

--
-- TOC entry 240 (class 1259 OID 40995)
-- Name: country_language; Type: TABLE; Schema: world; Owner: postgres
--

CREATE TABLE world.country_language (
    country_code character(3) NOT NULL,
...
ALTER TABLE world.country_language OWNER TO postgres;

--
-- TOC entry 2931 (class 0 OID 40983)
-- Dependencies: 238
-- Data for Name: city; Type: TABLE DATA; Schema: world; Owner: postgres
--

COPY world.city (id, name, country_code, district, population) FROM stdin;
...
--
-- TOC entry 2932 (class 0 OID 40989)
-- Dependencies: 239
-- Data for Name: country; Type: TABLE DATA; Schema: world; Owner: postgres
--

COPY world.country (code, name, continent, region, surface_area, indep_year, population, life_expectancy, gnp, gnp_old, local_name, government_form, head_of_state, capital, code2) FROM stdin;
...
--
-- TOC entry 2933 (class 0 OID 40995)
-- Dependencies: 240
-- Data for Name: country_language; Type: TABLE DATA; Schema: world; Owner: postgres
--

COPY world.country_language (country_code, language, is_official, percentage) FROM stdin;
...
-- Completed on 2022-11-18 01:06:15
